...
//const WCHAR *szTitle = L"LR5_1";                  // Текст строки заголовка
//const WCHAR *szWindowClass = L"LR5_1";
//mbtowc(szTitle, "LR5_1", 5);

LPCWSTR szTitle = L"LR5_1";
LPCWSTR szWindowClass = L"LR5_1";
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam) {
	...
	case WM_COMMAND: {
		...
		if (LOWORD(wParam) == 2) {
			...
			HWND hRecieverWnd = FindWindow(NULL, L"LR5_2");
			if (hRecieverWnd != 0)
			{
